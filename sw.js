...
var CACHE_NAME = 'psy3-pro-v24'; // session 41 // session 40 // session 39 // session 38 // session 37 // session 36 // session 35 // session 34 // session 33 // session 32 // session 31 // session 30 // session 29 // session 28 // session 27 // session 26: arrangement editor
var APP_SHELL = [
  'index.html',
